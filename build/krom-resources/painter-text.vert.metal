...
struct painter_text_vert_main_uniforms
{
    float4x4 projectionMatrix;
};

struct painter_text_vert_main_out
{
...
struct painter_text_vert_main_in
{
...
vertex painter_text_vert_main_out painter_text_vert_main(painter_text_vert_main_in in [[stage_in]], constant painter_text_vert_main_uniforms& uniforms [[buffer(1)]])
{
    painter_text_vert_main_out out = {};
